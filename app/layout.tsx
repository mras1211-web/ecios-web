...
import { Source_Serif_4, IBM_Plex_Sans_Arabic, IBM_Plex_Mono } from "next/font/google";
import "./globals.css";

const display = Source_Serif_4({ subsets: ["latin"], variable: "--font-display", weight: ["500", "600"] });
const sans = IBM_Plex_Sans_Arabic({ subsets: ["arabic", "latin"], variable: "--font-sans", weight: ["400", "500", "600"] });
